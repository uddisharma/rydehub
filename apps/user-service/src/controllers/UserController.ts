...
import { CreateUserInput, CreateUserInputType, LoginUserInput, LoginUserInputType } from '../types/types';
import { RedisManager } from '../redis/RedisManager';
import { LOGIN_SAVE, REGISTER_SAVE } from '../types/index';

export const registerUser = async (userData: CreateUserInputType, clientId: string) => {
...
export const loginUser = async (loginData: LoginUserInputType, clientId: string) => {
