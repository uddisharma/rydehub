...
export const CalculateFareAndDistance = async (reqData: CalculateFareType, clientId: string) => {
        ...
        try {
            ...
            RedisManager.getInstance().sendToApi(clientId, {
                ...
                payload: {
                    ...
                    "message": result ? "Fare calculated successfully" : "Error calculating fare",
