...
const CardsafetyProtect: FunctionComponent<CardsafetyProtectType> = ({
  className = "",
}) => {
  return (
    <div
      className={`self-stretch shadow-[0px_2px_20px_rgba(0,_0,_0,_0.1)] rounded-spacing-spacing-24 bg-surface-surface-default-white flex flex-row flex-wrap items-start justify-start p-4 gap-[16px] z-[1] text-left text-base text-text-text-neutral-dark font-body-small ${className}`}
    >
